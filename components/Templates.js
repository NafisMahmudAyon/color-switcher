...
const Templates = () => {
  return (
    <div
      data-new-gr-c-s-check-loaded="14.1109.0"
      data-gr-ext-installed=""
      cz-shortcut-listen="true"
    >
      <section id="top-1" className="hidden"
    //   style="display: none;"
      >
        <a href="https://mobiri.se/a3">Best Website Design Ideas</a> Mobirise
        v5.6.4 <a href="https://mobiri.se/a6">Web Page Development Software</a>
      </section>

      <section
        data-bs-version="5.1"
        class="menu menu1 cid-tlVfrwbwzd"
        once="menu"
        id="menu01-0"
      >
          ...
          <div class="container">
            <div class="navbar-brand">
              <span class="navbar-caption-wrap">
                <a
                  class="navbar-caption text-black display-5"
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav nav-dropdown" data-app-modern-menu="true">
                ...
                <li class="nav-item">
                  <a
                    class="nav-link link text-secondary show display-4"
                    href="https://mobiri.se/"
                    aria-expanded="true"
                  >
                    Features
        ...
        <div class="container">
          <div class="row justify-content-center">
              ...
              <div class="text-wrapper align-left md-pb">
                <div class="subtitle-align-wrap">
                  <div class="subtitle-wrap">
                    ...
                    <span class="mbr-iconfont arrow mobi-mbri-right mobi-mbri"></span>
                  </div>
                </div>
            ...
            <div class="col-12 col-md-12 col-lg-5 image-wrapper">
              <img
                class="w-100"
                src="./DevM5 Theme Web Development Framework Demo_files/features3.jpg"
        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-12 col-md-12 col-lg">
              <div class="text-wrapper align-left md-pb">
                ...
                <p class="mbr-text mbr-fonts-style mb-4 display-4">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                  Mauris imperdiet commodo felis a interdum.
                </p>
            ...
            <div class="col-12 col-md-12 col-lg-6 image-wrapper">
              <img
                class="w-100"
                src="./DevM5 Theme Web Development Framework Demo_files/features1.jpg"
                alt="Mobirise Website Builder"
              />
            </div>
          </div>
          ...
          <div class="row justify-content-center">
            <div class="col-12 col-md-12 col-lg-10">
              <div class="text-wrapper align-left md-pb">
                ...
                <p class="mbr-text mbr-fonts-style display-7">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                  Mauris&nbsp;leo imperdiet commodo felis a interdum. Nam
                  lacinia nisl sed accumsan hendrerit. In urna massa, ut
                  ullamcorper leo porta et. Praesent id placerat justo.
                </p>
              </div>
            </div>
          </div>
                  ...
                  <div class="card-big">
                    <div class="card-box align-left">
                      ...
                      <p class="cardbig-text mbr-fonts-style display-4">
                        ...
                        fringilla elementum tortor at ultrices. Curabitur non
                        arcu diam. Donec malesuada pharetra pharetra. In congue
                        commodo bibendum.
                      </p>
        ...
        <div class="container">
          <div class="row justify-content-center">
            ...
            <div class="col-12 pt-4 col-md-12 col-lg-8 image-wrapper">
              <img
                class="w-100"
                src="./DevM5 Theme Web Development Framework Demo_files/features2.jpg"
                alt="Mobirise Website Builder"
              />
            </div>
          </div>
        ...
        <div class="container">
          ...
          <div class="row wrap justify-content-center">
            <div class="col-lg-3 col-sm-6">
              <div class="image">
                <img
                  src="./DevM5 Theme Web Development Framework Demo_files/team1.jpg"
                  alt=""
                  title=""
                />
            ...
            <div class="col-lg-3 col-sm-6">
              <div class="image">
                <img
                  src="./DevM5 Theme Web Development Framework Demo_files/team2.jpg"
                  alt=""
                  title=""
                />
                <div class="text__block text-white">
            ...
            <div class="col-lg-3 col-sm-6">
              <div class="image">
                <img
                  src="./DevM5 Theme Web Development Framework Demo_files/team3.jpg"
                  alt=""
                  title=""
                />
                <div class="text__block text-white">
            ...
            <div class="col-lg-3 col-sm-6">
              <div class="image">
                <img
                  src="./DevM5 Theme Web Development Framework Demo_files/team4.jpg"
                  alt=""
                  title=""
                />
                <div class="text__block text-white">
        ...
        <div class="images-container container">
          ...
          <div class="row justify-content-center mt-4">
            <div class="col-md-3 card">
              <img
                src="./DevM5 Theme Web Development Framework Demo_files/1.png"
                alt="Mobirise Website Builder"
              />
            </div>
            <div class="col-md-3 card">
              <img
                src="./DevM5 Theme Web Development Framework Demo_files/2.png"
                alt="Mobirise Website Builder"
              />
            </div>
            <div class="col-md-3 card">
              <img
                src="./DevM5 Theme Web Development Framework Demo_files/3.png"
                alt="Mobirise Website Builder"
              />
            </div>
            <div class="col-md-3 card">
              <img
                src="./DevM5 Theme Web Development Framework Demo_files/4.png"
                alt="Mobirise Website Builder"
              />
            </div>
            <div class="col-md-3 card">
          ...
          <div class="row mbr-white">
            ...
            <div class="col-12 col-md-6 col-lg-3">
              ...
              <ul class="list mbr-fonts-style display-4">
                <li class="mbr-text item-wrap">Optimized code</li>
                <li class="mbr-text item-wrap">Best solutions</li>
                <li class="mbr-text item-wrap">Time saving</li>
                <li class="mbr-text item-wrap">Web development</li>
                <li class="mbr-text item-wrap">Mobile app</li>
                <li class="mbr-text item-wrap">Our framework</li>
              </ul>
            </div>
            <div class="col-12 col-md-6 col-lg-3">
              <h5 class="mbr-section-subtitle mbr-fonts-style mb-2 display-7">
              ...
              <ul class="list mbr-fonts-style display-4">
                <li class="mbr-text item-wrap">Web sites</li>
                <li class="mbr-text item-wrap">Applications</li>
                <li class="mbr-text item-wrap">Mobile app</li>
                <li class="mbr-text item-wrap">Testing</li>
              </ul>
            </div>
            <div class="col-12 col-md-6 col-lg-3">
              <h5 class="mbr-section-subtitle mbr-fonts-style mb-2 display-7">
