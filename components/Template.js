...
const Template = (props) => {
  ...
  return (
    <div className="text-gray-800 antialiased relative">
      ...
      <main>
        <div
          className="relative pt-16 pb-32 flex content-center items-center justify-center min-h-[75vh]"
          // style="min-height: 75vh;"
        >
          <div
            className="absolute top-0 w-full h-full bg-center bg-cover bg-[url('/bg.jpg')]"
            //   style='background-image: url("https://images.unsplash.com/photo-1557804506-669a67965ba0");'
          >
            <span
              id="blackOverlay"
                ...
                <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-gray-300">
                  <div className="flex-auto p-5 lg:p-10">
                    ...
                    <div className="relative w-full mb-3 mt-8">
                      ...
                      <input
                        type="text"
                        className="border-0 px-3 py-3 placeholder-gray-400 text-gray-700 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full transition-all ease-in-out duration-150 delay-0"
                    ...
                    <div className="text-center mt-6">
                      <button
                        className="bg-gray-900 text-white active:bg-gray-700 text-sm font-bold uppercase px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 transition-all ease-in-out duration-150 delay-0"
                        type="button"
                      >
                        Send Message
                      </button>
